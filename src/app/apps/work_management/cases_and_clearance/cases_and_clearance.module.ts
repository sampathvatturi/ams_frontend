...
import { CasesAndClearanceRoutingModule } from './cases_and_clearance.routing';
...
@NgModule({
    imports: [
        ...
        NzGridModule,
        ...antdModule,
        CasesAndClearanceRoutingModule,
    ...
    ForestClearanceComponent,
                   CourtCasesComponent,
                   VigEnforcementComponent,
                   ArbitorationCaseComponent,
                   DeviationsComponent
  ],
    providers: [
        ToastrService,
...
export class CasesAndClearanceModule { }