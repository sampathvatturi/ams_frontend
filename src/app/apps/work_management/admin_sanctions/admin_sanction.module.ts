...
import { AdminSanctionRoutingModule } from './admin_sanction.routing';
...
@NgModule({
    ...
    OriginalSactionsComponent,
                   AlternateSanctionsComponent,
                   RevisedSanctionsComponent,
                   DroppingOfSanctionWorksComponent
  ],
    providers: [
        ToastrService,
...
export class AdminSanctionModule { }