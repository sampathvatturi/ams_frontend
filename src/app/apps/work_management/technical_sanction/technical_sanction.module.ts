...
import { TechnicalSanctionRoutingModule } from './technical_sanction.routing';
...
@NgModule({
    imports: [
        ...
        NzGridModule,
        ...antdModule,
        TechnicalSanctionRoutingModule,
    ...
    WorkEngineerAllotmentComponent,
                   TechnicalSanctionComponent,
                   BridgeDesignComponent
  ],
    providers: [
        ToastrService,
...
export class TechnicalSanctionModule { }