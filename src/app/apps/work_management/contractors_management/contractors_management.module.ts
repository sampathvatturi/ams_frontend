...
import { ContractorsManagementRoutingModule } from './contractors_management.routing';
...
@NgModule({
    imports: [
        ...
        NzGridModule,
        ...antdModule,
        ContractorsManagementRoutingModule,
...
export class ContractorsManagementModule { }